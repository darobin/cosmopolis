  ...
  function y23(t6, c6) {
    ...
    for (r5 = 0; r5 < e34; r5 += 1)
      for (b4 = 0; b4 < e34; b4 += 1) {
        var g4 = a5, x3 = c6.left + b4 * h4, u7 = c6.top + r5 * h4, p4 = r5, q = b4, f6 = d4.a, k3 = x3 + h4, m5 = u7 + h4, D3 = p4 - 1, E5 = p4 + 1, n9 = q - 1, l8 = q + 1, y32 = Math.floor(Math.min(0.5, Math.max(0, c6.R)) * h4), v22 = f6(p4, q), I2 = f6(D3, n9), w23 = f6(D3, q);
        D3 = f6(D3, l8);
        var F2 = f6(p4, l8);
        l8 = f6(E5, l8);
        q = f6(
        ...
        k3 = Math.round(k3);
        m5 = Math.round(m5);
        v22 ? C4(g4, x3, u7, k3, m5, y32, !w23 && !p4, !w23 && !F2, !q && !F2, !q && !p4) : z4(g4, x3, u7, k3, m5, y32, w23 && p4 && I2, w23 && F2 && D3, q && F2 && l8, q && p4 && E5);
      }
    A3(a5, c6);
    a5.fill();
    return t6;
    ...
    function b4(b23, a24) {
          ...
          if (null == r5[p4][q])
            for (var n9 = -2; 2 >= n9; n9 += 1)
              for (var l8 = -2; 2 >= l8; l8 += 1)
                r5[p4 + n9][q + l8] = -2 == n9 || 2 == n9 || -2 == l8 || 2 == l8 || 0 == n9 && 0 == l8;
        }
      ...
      if (null == g4) {
        ...
        for (n9 = 0; n9 < b23.length; n9 += 1) {
          ...
          m5 = Math.max(m5, w23);
          p4[n9] = Array(v22);
          for (l8 = 0; l8 < p4[n9].length; l8 += 1)
            p4[n9][l8] = 255 & f6.B()[l8 + u23];
          u23 += v22;
          l8 = y23.C(w23);
          v22 = z4(p4[n9], l8.b() - 1).l(l8);
          q[n9] = Array(l8.b() - 1);
        ...
        for (l8 = u23 = 0; l8 < k3; l8 += 1)
          for (n9 = 0; n9 < b23.length; n9 += 1)
            l8 < p4[n9].length && (f6[u23] = p4[n9][l8], u23 += 1);
        for (l8 = 0; l8 < m5; l8 += 1)
          for (n9 = 0; n9 < b23.length; n9 += 1)
      ...
      for (q = d4 - 1; 0 < q; q -= 2)
        for (6 == q && --q; ; ) {
          for (n9 = 0; 2 > n9; n9 += 1)
            null == r5[k3][q - n9] && (l8 = false, p4 < b23.length && (l8 = 1 == (b23[p4] >>> m5 & 1)), a24(k3, q - n9) && (l8 = !l8), r5[k3][q - n9] = l8, --m5, -1 == m5 && (p4 += 1, m5 = 7));
          k3 += f6;
          if (0 > k3 || d4 <= k3) {
            k3 -= f6;
            f6 = -f6;
  ...
  var A3 = { L: 1, M: 0, Q: 3, H: 2 }, y23 = function() {
    ...
    var a5 = [
      ...
      for (var a24 = b4.h(), c24 = 0, d4 = 0; d4 < a24; d4 += 1)
        for (var g4 = 0; g4 < a24; g4 += 1) {
          for (var e44 = 0, t22 = b4.a(d4, g4), p4 = -1; 1 >= p4; p4 += 1)
            if (!(0 > d4 + p4 || a24 <= d4 + p4))
              for (var q = -1; 1 >= q; q += 1)
                0 > g4 + q || a24 <= g4 + q || (0 != p4 || 0 != q) && t22 == b4.a(d4 + p4, g4 + q) && (e44 += 1);
          5 < e44 && (c24 += 3 + e44 - 5);
        }
    ...
    var a5 = [
      ...
      for (var d4 = 0; d4 < b4; d4 += 1)
        for (var g4 = e44[3 * d4], h4 = e44[3 * d4 + 1], t22 = e44[3 * d4 + 2], p4 = 0; p4 < g4; p4 += 1) {
          var q = t22, f6 = {};
          f6.o = h4;
          f6.j = q;
          a24.push(f6);
...
function hslToRgb(h4, s8, l25) {
  ...
  if (s8 === 0) {
    ...
    var p4 = 2 * l25 - q;
    r5 = hue2rgb(p4, q, h4 + 1 / 3);
    g4 = hue2rgb(p4, q, h4);
    b4 = hue2rgb(p4, q, h4 - 1 / 3);
  }
...
function hsvToRgb(h4, s8, v3) {
  ...
  var mod = i33 % 6;
  var r5 = [v3, q, p4, p4, t22, v3][mod];
  var g4 = [t22, v3, v3, q, p4, p4][mod];
  var b4 = [p4, p4, t22, v3, v3, q][mod];
  return { r: r5 * 255, g: g4 * 255, b: b4 * 255 };
}
...
var r4 = async (t22, e44, n32) => {
  ...
  for (let n42 = 0; n42 < s33.length; n42++) {
    ...
    u32 = null != y4 ? y4 : u32, m32 = null != x3 ? x3 : m32, d32 = __spreadProps(__spreadValues({}, d32), { [a42]: __spreadValues(__spreadValues({}, d32[a42]), w32) }), v3 && p32 <= 50 && (p32++, "object" == typeof v3 && (v3.placement && (g32 = v3.placement), v3.rects && (f32 = true === v3.rects ? await l32.getElementRects({ reference: t22, floating: e44, strategy: r32 }) : v3.rects), { x: u32, y: m32 } = i24(f32, g32, c32)), n42 = -1);
  }
...
var m4 = (n32) => ({ name: "arrow", options: n32, async fn(i42) {
  ...
  if (null == r32)
    return {};
  const d32 = a4(l32), p32 = { x: s33, y: c32 }, h32 = o24(f32), y4 = e33(h32), x3 = await g32.getDimensions(r32), w32 = "y" === h32 ? "top" : "left", v3 = "y" === h32 ? "bottom" : "right", b32 = m32.reference[y4] + m32.reference[h32] - p32[h32] - m32.floating[y4], R22 = p32[h32] - m32.reference[h32], A22 = await (null == g32.getOffsetParent ? void 0 : g32.getOffsetParent(r32));
...
var E4 = function(t22) {
  return void 0 === t22 && (t22 = {}), { name: "shift", options: t22, async fn(e44) {
    ...
    let y4 = g32[p32], x3 = g32[h32];
    if (l32) {
      const t33 = "y" === p32 ? "bottom" : "right";
      y4 = u6(y4 + d32["y" === p32 ? "top" : "left"], y4, y4 - d32[t33]);
    }
    if (c32) {
      const t33 = "y" === h32 ? "bottom" : "right";
      x3 = u6(x3 + d32["y" === h32 ? "top" : "left"], x3, x3 - d32[t33]);
    }
    const w32 = f32.fn(__spreadProps(__spreadValues({}, e44), { [p32]: y4, [h32]: x3 }));
...
var k2 = function(e44) {
  return void 0 === e44 && (e44 = {}), { name: "size", options: e44, async fn(o42) {
    ...
    const y4 = f5(m32.left, 0), x3 = f5(m32.right, 0), w32 = f5(m32.top, 0), v3 = f5(m32.bottom, 0), b32 = { availableHeight: r32.floating.height - (["left", "right"].includes(i42) ? 2 * (0 !== w32 || 0 !== v3 ? w32 + v3 : f5(m32.top, m32.bottom)) : m32[p32]), availableWidth: r32.floating.width - (["top", "bottom"].includes(i42) ? 2 * (0 !== y4 || 0 !== x3 ? y4 + x3 : f5(m32.left, m32.right)) : m32[h32]) };
...
p3.textContent = await c("welcome", { name: "cosmopolis" });
h1.after(p3);
