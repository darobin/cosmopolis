...
function hsvToRgb(h6, s12, v4) {
  ...
  var mod = i33 % 6;
  var r8 = [v4, q, p4, p4, t22, v4][mod];
  var g5 = [t22, v4, v4, q, p4, p4][mod];
  var b5 = [p4, p4, t22, v4, v4, q][mod];
  return { r: r8 * 255, g: g5 * 255, b: b5 * 255 };
}
...
var registry2 = {};
var subscriberQueue = [];
function registerStore(name, store3) {
  if (registry2[name])
    throw new Error(`Store "${name}" already registered.`);
  registry2[name] = store3;
}
...
// ui/db/contexts.js
var defaultValue2 = { contexts: null, current: null, err: null };
...
var V3 = class {
  ...
  v(t8) {
    ...
    for (; void 0 !== d6; ) {
      if (l11 === d6.index) {
        let i9;
        2 === d6.type ? i9 = new N2(n13, n13.nextSibling, this, t8) : 1 === d6.type ? i9 = new d6.ctor(n13, d6.name, d6.strings, this, t8) : 6 === d6.type && (i9 = new I2(n13, this, t8)), this.u.push(i9), d6 = e10[++r8];
      }
...
var Z2 = (t8, i8, s12) => {
  ...
  if (void 0 === l11) {
    ...
    n13._$litPart$ = l11 = new N2(i8.insertBefore(r7(), t9), t9, void 0, null != s12 ? s12 : {});
  }
...
var CosmoContexts = class extends s11 {
  constructor() {
    super();
    const store3 = getStore("contexts");
    this.open = false;
    this.contexts = null;
    this.current = null;
    this.cantEdit = false;
    ...
    this.editing = false;
    this.showHint = false;
    store3.subscribe(({ contexts: contexts2, current }) => {
    ...
    return y4`
      <div>
        ...
        <sl-drawer placement="start" ?open=${!!this.open} @sl-request-close=${this.handleCloseRequest}>
          ${this.showHint ? y4`<p class="hint">You have no contexts. Use the create button below to add one.</p>` : b4}
          ${this.cantEdit || this.editing || this.creating ? b4 : y4`<sl-icon-button slot="footer" name="pencil-square" label="Edit Context" @click=${this.handleEdit}></sl-icon-button>`}
          ${this.editing || this.creating ? b4 : y4`<sl-icon-button slot="footer" name="plus-square" label="Add Context" class="action" @click=${this.handleCreate}></sl-icon-button>`}
          ${this.editing ? y4`<sl-button slot="footer" size="small" class="action" @click=${this.handleDoneEditing}>Done</sl-button>` : b4}
          ${this.creating ? y4`
