...
var e = (c6, a5) => {
  for (var b4 in a5)
    d(c6, b4, { get: a5[b4], enumerable: true });
};
...
function s(e7, r5 = false) {
  let n9 = u(), t6 = `_${n9}`;
  return Object.defineProperty(window, t6, { value: (o8) => (r5 && Reflect.deleteProperty(window, t6), e7 == null ? void 0 : e7(o8)), writable: false, configurable: true }), n9;
}
async function c(e7, r5 = {}) {
  return new Promise((n9, t6) => {
    let o8 = s((i6) => {
      n9(i6), Reflect.deleteProperty(window, `_${a5}`);
    }, true), a5 = s((i6) => {
      t6(i6), Reflect.deleteProperty(window, `_${o8}`);
    }, true);
    window.__TAURI_IPC__({ cmd: e7, callback: o8, error: a5, ...r5 });
  });
}
function w(e7, r5 = "asset") {
  let n9 = encodeURIComponent(e7);
  return navigator.userAgent.includes("Windows") ? `https://${r5}.localhost/${n9}` : `${r5}://localhost/${n9}`;
}
...
async function s2(n9, t6) {
  return a({ __tauriModule: "Event", message: { cmd: "unlisten", event: n9, eventId: t6 } });
}
async function m(n9, t6, i6) {
  await a({ __tauriModule: "Event", message: { cmd: "emit", event: n9, windowLabel: t6, payload: i6 } });
}
async function o(n9, t6, i6) {
  return a({ __tauriModule: "Event", message: { cmd: "listen", event: n9, windowLabel: t6, handler: s(i6) } }).then((r5) => async () => s2(n9, r5));
}
async function u2(n9, t6, i6) {
  return o(n9, t6, (r5) => {
    i6(r5), s2(n9, r5.id).catch(() => {
    });
  });
}
var c2 = ((e7) => (e7.WINDOW_RESIZED = "tauri://resize", e7.WINDOW_MOVED = "tauri://move", e7.WINDOW_CLOSE_REQUESTED = "tauri://close-requested", e7.WINDOW_CREATED = "tauri://window-created", e7.WINDOW_DESTROYED = "tauri://destroyed", e7.WINDOW_FOCUS = "tauri://focus", e7.WINDOW_BLUR = "tauri://blur", e7.WINDOW_SCALE_FACTOR_CHANGED = "tauri://scale-change", e7.WINDOW_THEME_CHANGED = "tauri://theme-changed", e7.WINDOW_FILE_DROP = "tauri://file-drop", e7.WINDOW_FILE_DROP_HOVER = "tauri://file-drop-hover", e7.WINDOW_FILE_DROP_CANCELLED = "tauri://file-drop-cancelled", e7.MENU = "tauri://menu", e7.CHECK_UPDATE = "tauri://update", e7.UPDATE_AVAILABLE = "tauri://update-available", e7.INSTALL_UPDATE = "tauri://update-install", e7.STATUS_UPDATE = "tauri://update-status", e7.DOWNLOAD_PROGRESS = "tauri://update-download-progress", e7))(c2 || {});
async function E(n9, t6) {
  return o(n9, null, t6);
}
async function _(n9, t6) {
  return u2(n9, null, t6);
}
async function D(n9, t6) {
  return m(n9, void 0, t6);
}
...
var l = class {
  ...
  toLogical(e7) {
    return new m2(this.width / e7, this.height / e7);
  }
};
var c3 = class {
  constructor(e7, a5) {
...
var o2 = class {
  ...
  toLogical(e7) {
    return new c3(this.x / e7, this.y / e7);
  }
};
...
var u3 = class {
  constructor(e7) {
    this.label = e7, this.listeners = /* @__PURE__ */ Object.create(null);
  }
  async listen(e7, a5) {
    return this._handleTauriEvent(e7, a5) ? Promise.resolve(() => {
      let n9 = this.listeners[e7];
      n9.splice(n9.indexOf(a5), 1);
    }) : o(e7, this.label, a5);
  }
  async once(e7, a5) {
    return this._handleTauriEvent(e7, a5) ? Promise.resolve(() => {
  ...
  async emit(e7, a5) {
    if (P.includes(e7)) {
      for (let n9 of this.listeners[e7] || [])
        n9({ event: e7, id: -1, windowLabel: this.label, payload: a5 });
      return Promise.resolve();
    }
    return m(e7, this.label, a5);
  }
  _handleTauriEvent(e7, a5) {
    return P.includes(e7) ? (e7 in this.listeners ? this.listeners[e7].push(a5) : this.listeners[e7] = [a5], true) : false;
  }
};
var h = class extends u3 {
  ...
  async innerPosition() {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "innerPosition" } } } }).then(({ x: e7, y: a5 }) => new o2(e7, a5));
  }
  async outerPosition() {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "outerPosition" } } } }).then(({ x: e7, y: a5 }) => new o2(e7, a5));
  }
  async innerSize() {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "innerSize" } } } }).then(({ width: e7, height: a5 }) => new l(e7, a5));
  }
  async outerSize() {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "outerSize" } } } }).then(({ width: e7, height: a5 }) => new l(e7, a5));
  }
  async isFullscreen() {
  ...
  async requestUserAttention(e7) {
    let a5 = null;
    return e7 && (e7 === 1 ? a5 = { type: "Critical" } : a5 = { type: "Informational" }), a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "requestUserAttention", payload: a5 } } } });
  }
  async setResizable(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setResizable", payload: e7 } } } });
  }
  async setTitle(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setTitle", payload: e7 } } } });
  }
  async maximize() {
  ...
  async setDecorations(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setDecorations", payload: e7 } } } });
  }
  async setAlwaysOnTop(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setAlwaysOnTop", payload: e7 } } } });
  }
  async setSize(e7) {
    if (!e7 || e7.type !== "Logical" && e7.type !== "Physical")
      throw new Error("the `size` argument must be either a LogicalSize or a PhysicalSize instance");
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setSize", payload: { type: e7.type, data: { width: e7.width, height: e7.height } } } } } });
  }
  async setMinSize(e7) {
    if (e7 && e7.type !== "Logical" && e7.type !== "Physical")
      throw new Error("the `size` argument must be either a LogicalSize or a PhysicalSize instance");
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setMinSize", payload: e7 ? { type: e7.type, data: { width: e7.width, height: e7.height } } : null } } } });
  }
  async setMaxSize(e7) {
    if (e7 && e7.type !== "Logical" && e7.type !== "Physical")
      throw new Error("the `size` argument must be either a LogicalSize or a PhysicalSize instance");
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setMaxSize", payload: e7 ? { type: e7.type, data: { width: e7.width, height: e7.height } } : null } } } });
  }
  async setPosition(e7) {
    if (!e7 || e7.type !== "Logical" && e7.type !== "Physical")
      throw new Error("the `position` argument must be either a LogicalPosition or a PhysicalPosition instance");
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setPosition", payload: { type: e7.type, data: { x: e7.x, y: e7.y } } } } } });
  }
  async setFullscreen(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setFullscreen", payload: e7 } } } });
  }
  async setFocus() {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setFocus" } } } });
  }
  async setIcon(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setIcon", payload: { icon: typeof e7 == "string" ? e7 : Array.from(e7) } } } } });
  }
  async setSkipTaskbar(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setSkipTaskbar", payload: e7 } } } });
  }
  async setCursorGrab(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setCursorGrab", payload: e7 } } } });
  }
  async setCursorVisible(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setCursorVisible", payload: e7 } } } });
  }
  async setCursorIcon(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setCursorIcon", payload: e7 } } } });
  }
  async setCursorPosition(e7) {
    if (!e7 || e7.type !== "Logical" && e7.type !== "Physical")
      throw new Error("the `position` argument must be either a LogicalPosition or a PhysicalPosition instance");
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setCursorPosition", payload: { type: e7.type, data: { x: e7.x, y: e7.y } } } } } });
  }
  async setIgnoreCursorEvents(e7) {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "setIgnoreCursorEvents", payload: e7 } } } });
  }
  async startDragging() {
    return a({ __tauriModule: "Window", message: { cmd: "manage", data: { label: this.label, cmd: { type: "startDragging" } } } });
  }
  async onResized(e7) {
    return this.listen("tauri://resize", e7);
  }
  async onMoved(e7) {
    return this.listen("tauri://move", e7);
  }
  async onCloseRequested(e7) {
    return this.listen("tauri://close-requested", (a5) => {
      let n9 = new y(a5);
      Promise.resolve(e7(n9)).then(() => {
        if (!n9.isPreventDefault())
          return this.close();
      });
    });
  }
  async onFocusChanged(e7) {
    let a5 = await this.listen("tauri://focus", (d4) => {
      e7({ ...d4, payload: true });
    }), n9 = await this.listen("tauri://blur", (d4) => {
      e7({ ...d4, payload: false });
    });
    return () => {
      a5(), n9();
  ...
  async onScaleChanged(e7) {
    return this.listen("tauri://scale-change", e7);
  }
  async onMenuClicked(e7) {
    return this.listen("tauri://menu", e7);
  }
  async onFileDropEvent(e7) {
    let a5 = await this.listen("tauri://file-drop", (r5) => {
      e7({ ...r5, payload: { type: "drop", paths: r5.payload } });
    }), n9 = await this.listen("tauri://file-drop-hover", (r5) => {
      e7({ ...r5, payload: { type: "hover", paths: r5.payload } });
    }), d4 = await this.listen("tauri://file-drop-cancelled", (r5) => {
      e7({ ...r5, payload: { type: "cancel" } });
    });
    return () => {
      a5(), n9(), d4();
    };
  }
  async onThemeChanged(e7) {
    return this.listen("tauri://theme-changed", e7);
  }
};
var y = class {
  constructor(e7) {
    this._preventDefault = false;
    this.event = e7.event, this.windowLabel = e7.windowLabel, this.id = e7.id;
  }
  preventDefault() {
...
var s3 = class extends h {
  constructor(e7, a5 = {}) {
    super(e7), a5 != null && a5.skip || a({ __tauriModule: "Window", message: { cmd: "createWebview", data: { options: { label: e7, ...a5 } } } }).then(async () => this.emit("tauri://created")).catch(async (n9) => this.emit("tauri://error", n9));
  }
  static getByLabel(e7) {
    return M().some((a5) => a5.label === e7) ? new s3(e7, { skip: true }) : null;
  }
};
var b;
...
function g(i6) {
  return i6 === null ? null : { name: i6.name, scaleFactor: i6.scaleFactor, position: new o2(i6.position.x, i6.position.y), size: new l(i6.size.width, i6.size.height) };
}
async function E2() {
...
var { I: l4 } = L;
var e23 = (o8) => void 0 === o8.strings;
var f4 = {};
var s5 = (o8, l32 = f4) => o8._$AH = l32;
var l23 = e4(class extends i3 {
  ...
  update(i25, [t22]) {
    if (t22 === x || t22 === b2)
      return t22;
    const o8 = i25.element, l32 = i25.name;
    if (i25.type === t3.PROPERTY) {
      if (t22 === o8[l32])
        return x;
    } else if (i25.type === t3.BOOLEAN_ATTRIBUTE) {
      if (!!t22 === o8.hasAttribute(l32))
        return x;
    } else if (i25.type === t3.ATTRIBUTE && o8.getAttribute(l32) === t22 + "")
      return x;
    return s5(i25), t22;
  }
});
...
var o5 = e4(class extends i3 {
  ...
  update(i25, [s8]) {
    ...
    if (void 0 === this.nt) {
      ...
      for (const t22 in s8)
        s8[t22] && !(null === (r5 = this.st) || void 0 === r5 ? void 0 : r5.has(t22)) && this.nt.add(t22);
      return this.render(s8);
    }
    const e25 = i25.element.classList;
    this.nt.forEach((t22) => {
      t22 in s8 || (e25.remove(t22), this.nt.delete(t22));
    });
    for (const t22 in s8) {
      const i33 = !!s8[t22];
...
var o6 = ({ finisher: e52, descriptor: t22 }) => (o25, n23) => {
  var r5;
  if (void 0 === n23) {
    const n32 = null !== (r5 = o25.originalKey) && void 0 !== r5 ? r5 : o25.key, i33 = null != t22 ? { kind: "method", placement: "prototype", key: n32, descriptor: t22(o25.key) } : __spreadProps(__spreadValues({}, o25), { key: n32 });
...
var SlTabGroup = class extends ShoelaceElement {
  ...
  connectedCallback() {
    ...
    this.mutationObserver = new MutationObserver((mutations) => {
      if (mutations.some((m5) => !["aria-labelledby", "aria-controls"].includes(m5.attributeName))) {
        setTimeout(() => this.setAriaLabels());
      }
      if (mutations.some((m5) => m5.attributeName === "disabled")) {
...
var SlSplitPanel = class extends ShoelaceElement {
  ...
  handleDrag(event) {
    ...
    drag(this, {
      onMove: (x3, y23) => {
        let newPositionInPixels = this.vertical ? y23 : x3;
        if (this.primary === "end") {
...
var i23 = e4(class extends i3 {
  ...
  render(t22) {
    return Object.keys(t22).reduce((e25, r5) => {
      const s8 = t22[r5];
      return null == s8 ? e25 : e25 + `${r5 = r5.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, "-$&").toLowerCase()}:${s8};`;
    }, "");
  }
  update(e25, [r5]) {
    const { style: s8 } = e25.element;
    if (void 0 === this.vt) {
    ...
    this.vt.forEach((t22) => {
      null == r5[t22] && (this.vt.delete(t22), t22.includes("-") ? s8.removeProperty(t22) : s8[t22] = "");
    });
    for (const t22 in r5) {
      const e34 = r5[t22];
      null != e34 && (this.vt.add(t22), t22.includes("-") ? s8.setProperty(t22, e34) : s8[t22] = e34);
    }
    return x;
  }
});
...
function getBasePath() {
  if (!basePath) {
    ...
    if (configScript) {
      ...
      const fallbackScript = scripts.find((s8) => /shoelace(\.min)?\.js($|\?)/.test(s8.src));
      let path = "";
      if (fallbackScript) {
...
var i5 = (t6, ...r5) => ({ _$litStatic$: r5.reduce((r23, e25, l25) => r23 + ((t22) => {
...
var a3 = (t6) => (r5, ...e25) => {
  ...
  let c6, $2 = 0, f6 = false;
  for (; $2 < o8; ) {
    for (c6 = r5[$2]; $2 < o8 && void 0 !== (a24 = e25[$2], i25 = l6(a24)); )
      c6 += i25 + r5[++$2], f6 = true;
    u23.push(a24), n23.push(c6), $2++;
  }
  if ($2 === o8 && n23.push(r5[o8]), f6) {
    const t22 = n23.join("$$lit$$");
    void 0 === (r5 = s6.get(t22)) && (n23.raw = n23, s6.set(t22, r5 = n23)), e25 = u23;
  }
  return t6(r5, ...e25);
};
var n7 = a3(y2);
...
H2.render = function(w4, B) {
  G(w4, B);
};
self.QrCreator = H2;
(function(w4) {
  function B(t6, c6, a5, e34) {
    var b4 = {}, h4 = w4(a5, c6);
    h4.u(t6);
    h4.J();
    e34 = e34 || 0;
    ...
    b4.a = function(b23, a24) {
      b23 -= e34;
      a24 -= e34;
      return 0 > b23 || b23 >= r5 || 0 > a24 || a24 >= r5 ? false : h4.a(b23, a24);
    };
    return b4;
  }
  function C4(t6, c6, a5, e34, b4, h4, r5, d4, g4, x3) {
    function u7(b23, a24, f6, c24, d24, r23, g23) {
      b23 ? (t6.lineTo(a24 + r23, f6 + g23), t6.arcTo(a24, f6, c24, d24, h4)) : t6.lineTo(a24, f6);
    }
    r5 ? t6.moveTo(c6 + h4, a5) : t6.moveTo(c6, a5);
    u7(d4, e34, a5, e34, b4, -h4, 0);
    u7(g4, e34, b4, c6, b4, 0, -h4);
    u7(x3, c6, b4, c6, a5, h4, 0);
    u7(r5, c6, a5, e34, a5, 0, h4);
  }
  function z4(t6, c6, a5, e34, b4, h4, r5, d4, g4, x3) {
    function u7(b23, a24, c24, d24) {
      t6.moveTo(b23 + c24, a24);
      t6.lineTo(
        b23,
        a24
      );
      t6.lineTo(b23, a24 + d24);
      t6.arcTo(b23, a24, b23 + c24, a24, h4);
    }
    r5 && u7(c6, a5, h4, h4);
    d4 && u7(e34, a5, -h4, h4);
    g4 && u7(e34, b4, -h4, -h4);
  ...
  function A3(t6, c6) {
    ...
    if ("string" === typeof a5)
      ...
      var e34 = a5.type, b4 = a5.colorStops;
      a5 = a5.position.map((b23) => Math.round(b23 * c6.size));
  ...
  function y23(t6, c6) {
    a: {
      var a5 = c6.text, e34 = c6.v, b4 = c6.N, h4 = c6.K, r5 = c6.P;
      b4 = Math.max(1, b4 || 1);
      for (h4 = Math.min(40, h4 || 40); b4 <= h4; b4 += 1)
        try {
          var d4 = B(a5, e34, b4, r5);
          break a;
        } catch (J) {
        }
      d4 = void 0;
    ...
    if (!d4)
      return null;
    a5 = t6.getContext("2d");
    c6.background && (a5.fillStyle = c6.background, a5.fillRect(c6.left, c6.top, c6.size, c6.size));
    e34 = d4.O;
    h4 = c6.size / e34;
    a5.beginPath();
    for (r5 = 0; r5 < e34; r5 += 1)
      for (b4 = 0; b4 < e34; b4 += 1) {
        var g4 = a5, x3 = c6.left + b4 * h4, u7 = c6.top + r5 * h4, p3 = r5, q = b4, f6 = d4.a, k3 = x3 + h4, m5 = u7 + h4, D3 = p3 - 1, E5 = p3 + 1, n9 = q - 1, l8 = q + 1, y32 = Math.floor(Math.min(0.5, Math.max(0, c6.R)) * h4), v22 = f6(p3, q), I2 = f6(D3, n9), w23 = f6(D3, q);
        D3 = f6(D3, l8);
        var F2 = f6(p3, l8);
        l8 = f6(E5, l8);
        q = f6(
        ...
        k3 = Math.round(k3);
        m5 = Math.round(m5);
        v22 ? C4(g4, x3, u7, k3, m5, y32, !w23 && !p3, !w23 && !F2, !q && !F2, !q && !p3) : z4(g4, x3, u7, k3, m5, y32, w23 && p3 && I2, w23 && F2 && D3, q && F2 && l8, q && p3 && E5);
      }
    A3(a5, c6);
    a5.fill();
    return t6;
  ...
  G = function(t6, c6) {
    ...
    if (c6 instanceof HTMLCanvasElement) {
      if (c6.width !== a5.size || c6.height !== a5.size)
        c6.width = a5.size, c6.height = a5.size;
      c6.getContext("2d").clearRect(0, 0, c6.width, c6.height);
      y23(c6, a5);
    } else
      t6 = document.createElement("canvas"), t6.width = a5.size, t6.height = a5.size, a5 = y23(t6, a5), c6.appendChild(a5);
  };
})(function() {
  function w4(c6) {
    var a5 = C4.s(c6);
    return { S: function() {
      ...
      for (var b4 = 0; b4 < a5.length; b4 += 1)
        c24.put(a5[b4], 8);
    } };
  }
  function B() {
    var c6 = [], a5 = 0, e34 = {
      ...
      put: function(b4, h4) {
        for (var a24 = 0; a24 < h4; a24 += 1)
          e34.m(1 == (b4 >>> h4 - a24 - 1 & 1));
      },
      f: function() {
        return a5;
      },
  ...
  function C4(c6, a5) {
    function e34(b23, h24) {
      for (var a24 = -1; 7 >= a24; a24 += 1)
        if (!(-1 >= b23 + a24 || d4 <= b23 + a24))
          for (var c24 = -1; 7 >= c24; c24 += 1)
            -1 >= h24 + c24 || d4 <= h24 + c24 || (r5[b23 + a24][h24 + c24] = 0 <= a24 && 6 >= a24 && (0 == c24 || 6 == c24) || 0 <= c24 && 6 >= c24 && (0 == a24 || 6 == a24) || 2 <= a24 && 4 >= a24 && 2 <= c24 && 4 >= c24 ? true : false);
    }
    function b4(b23, a24) {
      for (var f6 = d4 = 4 * c6 + 17, k3 = Array(f6), m5 = 0; m5 < f6; m5 += 1) {
        k3[m5] = Array(f6);
        for (var p3 = 0; p3 < f6; p3 += 1)
          k3[m5][p3] = null;
      }
      r5 = k3;
      e34(0, 0);
      ...
      e34(0, d4 - 7);
      f6 = y23.G(c6);
      for (k3 = 0; k3 < f6.length; k3 += 1)
        for (m5 = 0; m5 < f6.length; m5 += 1) {
          p3 = f6[k3];
          var q = f6[m5];
          if (null == r5[p3][q])
      ...
      for (f6 = 8; f6 < d4 - 8; f6 += 1)
        null == r5[f6][6] && (r5[f6][6] = 0 == f6 % 2);
      for (f6 = 8; f6 < d4 - 8; f6 += 1)
        null == r5[6][f6] && (r5[6][f6] = 0 == f6 % 2);
      f6 = y23.w(h4 << 3 | a24);
      for (k3 = 0; 15 > k3; k3 += 1)
        m5 = !b23 && 1 == (f6 >> k3 & 1), r5[6 > k3 ? k3 : 8 > k3 ? k3 + 1 : d4 - 15 + k3][8] = m5, r5[8][8 > k3 ? d4 - k3 - 1 : 9 > k3 ? 15 - k3 : 14 - k3] = m5;
      r5[d4 - 8][8] = !b23;
      if (7 <= c6) {
        f6 = y23.A(c6);
        for (k3 = 0; 18 > k3; k3 += 1)
          m5 = !b23 && 1 == (f6 >> k3 & 1), r5[Math.floor(k3 / 3)][k3 % 3 + d4 - 8 - 3] = m5;
        for (k3 = 0; 18 > k3; k3 += 1)
          m5 = !b23 && 1 == (f6 >> k3 & 1), r5[k3 % 3 + d4 - 8 - 3][Math.floor(k3 / 3)] = m5;
      }
      if (null == g4) {
        b23 = t6.I(c6, h4);
        f6 = B();
        for (k3 = 0; k3 < x3.length; k3 += 1)
          m5 = x3[k3], f6.put(4, 4), f6.put(m5.b(), y23.f(4, c6)), m5.write(f6);
        for (k3 = m5 = 0; k3 < b23.length; k3 += 1)
          m5 += b23[k3].j;
        if (f6.f() > 8 * m5)
          throw Error("code length overflow. (" + f6.f() + ">" + 8 * m5 + ")");
        for (f6.f() + 4 <= 8 * m5 && f6.put(0, 4); 0 != f6.f() % 8; )
          f6.m(false);
        for (; !(f6.f() >= 8 * m5); ) {
          f6.put(236, 8);
          if (f6.f() >= 8 * m5)
        ...
        for (n9 = 0; n9 < b23.length; n9 += 1) {
          ...
          for (l8 = 0; l8 < p3[n9].length; l8 += 1)
            p3[n9][l8] = 255 & f6.B()[l8 + u23];
          u23 += v22;
          l8 = y23.C(w23);
          v22 = z4(p3[n9], l8.b() - 1).l(l8);
          q[n9] = Array(l8.b() - 1);
          for (l8 = 0; l8 < q[n9].length; l8 += 1)
            w23 = l8 + v22.b() - q[n9].length, q[n9][l8] = 0 <= w23 ? v22.c(w23) : 0;
        }
        for (l8 = f6 = 0; l8 < b23.length; l8 += 1)
          f6 += b23[l8].o;
        f6 = Array(f6);
        for (l8 = u23 = 0; l8 < k3; l8 += 1)
          for (n9 = 0; n9 < b23.length; n9 += 1)
            l8 < p3[n9].length && (f6[u23] = p3[n9][l8], u23 += 1);
        for (l8 = 0; l8 < m5; l8 += 1)
          for (n9 = 0; n9 < b23.length; n9 += 1)
            l8 < q[n9].length && (f6[u23] = q[n9][l8], u23 += 1);
        g4 = f6;
      }
      b23 = g4;
      f6 = -1;
      ...
      for (q = d4 - 1; 0 < q; q -= 2)
        for (6 == q && --q; ; ) {
          for (n9 = 0; 2 > n9; n9 += 1)
            null == r5[k3][q - n9] && (l8 = false, p3 < b23.length && (l8 = 1 == (b23[p3] >>> m5 & 1)), a24(k3, q - n9) && (l8 = !l8), r5[k3][q - n9] = l8, --m5, -1 == m5 && (p3 += 1, m5 = 7));
          k3 += f6;
          if (0 > k3 || d4 <= k3) {
            k3 -= f6;
            f6 = -f6;
    ...
    var h4 = A3[a5], r5 = null, d4 = 0, g4 = null, x3 = [], u7 = { u: function(b23) {
      b23 = w4(b23);
      x3.push(b23);
      g4 = null;
    }, a: function(b23, a24) {
      if (0 > b23 || d4 <= b23 || 0 > a24 || d4 <= a24)
        throw Error(b23 + "," + a24);
      return r5[b23][a24];
    }, h: function() {
      return d4;
  ...
  function z4(c6, a5) {
    if ("undefined" == typeof c6.length)
      throw Error(c6.length + "/" + a5);
    var e34 = function() {
      for (var b23 = 0; b23 < c6.length && 0 == c6[b23]; )
        b23 += 1;
      for (var r5 = Array(c6.length - b23 + a5), d4 = 0; d4 < c6.length - b23; d4 += 1)
        r5[d4] = c6[d4 + b23];
      return r5;
    }(), b4 = { c: function(b23) {
      return e34[b23];
      ...
      for (var h4 = Array(b4.b() + a24.b() - 1), c24 = 0; c24 < b4.b(); c24 += 1)
        for (var g4 = 0; g4 < a24.b(); g4 += 1)
          h4[c24 + g4] ^= v3.i(v3.g(b4.c(c24)) + v3.g(a24.c(g4)));
      return z4(h4, 0);
    }, l: function(a24) {
      if (0 > b4.b() - a24.b())
        return b4;
      for (var c24 = v3.g(b4.c(0)) - v3.g(a24.c(0)), h4 = Array(b4.b()), g4 = 0; g4 < b4.b(); g4 += 1)
        h4[g4] = b4.c(g4);
      for (g4 = 0; g4 < a24.b(); g4 += 1)
        h4[g4] ^= v3.i(v3.g(a24.c(g4)) + c24);
      return z4(h4, 0).l(a24);
    } };
    return b4;
  }
  C4.s = function(c6) {
    for (var a5 = [], e34 = 0; e34 < c6.length; e34++) {
      var b4 = c6.charCodeAt(e34);
      128 > b4 ? a5.push(b4) : 2048 > b4 ? a5.push(192 | b4 >> 6, 128 | b4 & 63) : 55296 > b4 || 57344 <= b4 ? a5.push(224 | b4 >> 12, 128 | b4 >> 6 & 63, 128 | b4 & 63) : (e34++, b4 = 65536 + ((b4 & 1023) << 10 | c6.charCodeAt(e34) & 1023), a5.push(240 | b4 >> 18, 128 | b4 >> 12 & 63, 128 | b4 >> 6 & 63, 128 | b4 & 63));
    }
    return a5;
  };
  var A3 = { L: 1, M: 0, Q: 3, H: 2 }, y23 = function() {
    function c6(b4) {
      for (var a24 = 0; 0 != b4; )
        a24 += 1, b4 >>>= 1;
      return a24;
    ...
    var a5 = [
      ...
      for (var a24 = b4 << 10; 0 <= c6(a24) - c6(1335); )
        a24 ^= 1335 << c6(a24) - c6(1335);
      return (b4 << 10 | a24) ^ 21522;
    }, A: function(b4) {
      for (var a24 = b4 << 12; 0 <= c6(a24) - c6(7973); )
        a24 ^= 7973 << c6(a24) - c6(7973);
      return b4 << 12 | a24;
    }, G: function(b4) {
      return a5[b4 - 1];
    }, F: function(b4) {
      ...
      for (var a24 = b4.h(), c24 = 0, d4 = 0; d4 < a24; d4 += 1)
        for (var g4 = 0; g4 < a24; g4 += 1) {
          for (var e44 = 0, t22 = b4.a(d4, g4), p3 = -1; 1 >= p3; p3 += 1)
            if (!(0 > d4 + p3 || a24 <= d4 + p3))
              for (var q = -1; 1 >= q; q += 1)
                0 > g4 + q || a24 <= g4 + q || (0 != p3 || 0 != q) && t22 == b4.a(d4 + p3, g4 + q) && (e44 += 1);
          5 < e44 && (c24 += 3 + e44 - 5);
        }
      for (d4 = 0; d4 < a24 - 1; d4 += 1)
        for (g4 = 0; g4 < a24 - 1; g4 += 1)
          if (e44 = 0, b4.a(d4, g4) && (e44 += 1), b4.a(d4 + 1, g4) && (e44 += 1), b4.a(d4, g4 + 1) && (e44 += 1), b4.a(d4 + 1, g4 + 1) && (e44 += 1), 0 == e44 || 4 == e44)
            c24 += 3;
      for (d4 = 0; d4 < a24; d4 += 1)
        for (g4 = 0; g4 < a24 - 6; g4 += 1)
          b4.a(d4, g4) && !b4.a(d4, g4 + 1) && b4.a(d4, g4 + 2) && b4.a(d4, g4 + 3) && b4.a(d4, g4 + 4) && !b4.a(d4, g4 + 5) && b4.a(d4, g4 + 6) && (c24 += 40);
      for (g4 = 0; g4 < a24; g4 += 1)
        for (d4 = 0; d4 < a24 - 6; d4 += 1)
          b4.a(d4, g4) && !b4.a(d4 + 1, g4) && b4.a(d4 + 2, g4) && b4.a(d4 + 3, g4) && b4.a(d4 + 4, g4) && !b4.a(d4 + 5, g4) && b4.a(d4 + 6, g4) && (c24 += 40);
      for (g4 = e44 = 0; g4 < a24; g4 += 1)
        for (d4 = 0; d4 < a24; d4 += 1)
          b4.a(d4, g4) && (e44 += 1);
    ...
    for (var c6 = Array(256), a5 = Array(256), e34 = 0; 8 > e34; e34 += 1)
      c6[e34] = 1 << e34;
    ...
    var a5 = [
      ...
      [34, 54, 24, 34, 55, 25],
      [20, 45, 15, 61, 46, 16]
    ], e34 = { I: function(b4, a24) {
      var e44 = c6(b4, a24);
      if ("undefined" == typeof e44)
        throw Error("bad rs block @ typeNumber:" + b4 + "/errorCorrectLevel:" + a24);
      b4 = e44.length / 3;
      a24 = [];
      for (var d4 = 0; d4 < b4; d4 += 1)
        for (var g4 = e44[3 * d4], h4 = e44[3 * d4 + 1], t22 = e44[3 * d4 + 2], p3 = 0; p3 < g4; p3 += 1) {
          var q = t22, f6 = {};
          f6.o = h4;
          f6.j = q;
          a24.push(f6);
...
function rgbToHsl(r5, g4, b4) {
  ...
  if (max === min) {
    ...
    var d4 = max - min;
    s8 = l25 > 0.5 ? d4 / (2 - max - min) : d4 / (max + min);
    switch (max) {
      case r5:
        h4 = (g4 - b4) / d4 + (g4 < b4 ? 6 : 0);
        break;
      case g4:
        h4 = (b4 - r5) / d4 + 2;
        break;
  ...
  return { h: h4, s: s8, l: l25 };
}
function hue2rgb(p3, q, t22) {
  if (t22 < 0) {
    t22 += 1;
  }
  if (t22 > 1) {
  ...
  if (t22 < 1 / 6) {
    return p3 + (q - p3) * (6 * t22);
  }
  if (t22 < 1 / 2) {
    return q;
  }
  if (t22 < 2 / 3) {
    return p3 + (q - p3) * (2 / 3 - t22) * 6;
  }
  return p3;
}
function hslToRgb(h4, s8, l25) {
  var r5;
  var g4;
  var b4;
  h4 = bound01(h4, 360);
  ...
  if (s8 === 0) {
    ...
    var q = l25 < 0.5 ? l25 * (1 + s8) : l25 + s8 - l25 * s8;
    var p3 = 2 * l25 - q;
    r5 = hue2rgb(p3, q, h4 + 1 / 3);
    g4 = hue2rgb(p3, q, h4);
    b4 = hue2rgb(p3, q, h4 - 1 / 3);
  }
  return { r: r5 * 255, g: g4 * 255, b: b4 * 255 };
}
function rgbToHsv(r5, g4, b4) {
  r5 = bound01(r5, 255);
  g4 = bound01(g4, 255);
  b4 = bound01(b4, 255);
  var max = Math.max(r5, g4, b4);
...
function hsvToRgb(h4, s8, v3) {
  ...
  var p3 = v3 * (1 - s8);
  var q = v3 * (1 - f6 * s8);
  var t22 = v3 * (1 - (1 - f6) * s8);
  var mod = i33 % 6;
  var r5 = [v3, q, p3, p3, t22, v3][mod];
  var g4 = [t22, v3, v3, q, p3, p3][mod];
  var b4 = [p3, p3, t22, v3, v3, q][mod];
  return { r: r5 * 255, g: g4 * 255, b: b4 * 255 };
}
function rgbToHex(r5, g4, b4, allow3Char) {
  var hex = [
...
function rgbaToHex(r5, g4, b4, a5, allow4Char) {
  var hex = [
    pad2(Math.round(r5).toString(16)),
    pad2(Math.round(g4).toString(16)),
    pad2(Math.round(b4).toString(16)),
...
var TinyColor = (
  ...
  function() {
    ...
    TinyColor2.prototype.toHslString = function() {
      ...
      return this.a === 1 ? "hsl(".concat(h4, ", ").concat(s8, "%, ").concat(l25, "%)") : "hsla(".concat(h4, ", ").concat(s8, "%, ").concat(l25, "%, ").concat(this.roundA, ")");
    };
    ...
    TinyColor2.prototype.toRgbString = function() {
      ...
      return this.a === 1 ? "rgb(".concat(r5, ", ").concat(g4, ", ").concat(b4, ")") : "rgba(".concat(r5, ", ").concat(g4, ", ").concat(b4, ", ").concat(this.roundA, ")");
    };
...
var _a;
var isChromium = (_a = navigator.userAgentData) == null ? void 0 : _a.brands.some((b4) => b4.brand.includes("Chromium"));
...
var r4 = async (t22, e44, n32) => {
  ...
  let f32 = await l32.getElementRects({ reference: t22, floating: e44, strategy: r32 }), { x: u32, y: m32 } = i24(f32, o42, c32), g32 = o42, d32 = {}, p3 = 0;
  for (let n42 = 0; n42 < s33.length; n42++) {
    const { name: a42, fn: h32 } = s33[n42], { x: y4, y: x3, data: w32, reset: v3 } = await h32({ x: u32, y: m32, initialPlacement: o42, placement: g32, strategy: r32, middlewareData: d32, rects: f32, platform: l32, elements: { reference: t22, floating: e44 } });
    u32 = null != y4 ? y4 : u32, m32 = null != x3 ? x3 : m32, d32 = __spreadProps(__spreadValues({}, d32), { [a42]: __spreadValues(__spreadValues({}, d32[a42]), w32) }), v3 && p3 <= 50 && (p3++, "object" == typeof v3 && (v3.placement && (g32 = v3.placement), v3.rects && (f32 = true === v3.rects ? await l32.getElementRects({ reference: t22, floating: e44, strategy: r32 }) : v3.rects), { x: u32, y: m32 } = i24(f32, g32, c32)), n42 = -1);
  }
...
async function s7(t22, e44) {
  var n32;
  void 0 === e44 && (e44 = {});
  const { x: o42, y: i42, platform: r32, rects: s33, elements: c32, strategy: f32 } = t22, { boundary: u32 = "clippingAncestors", rootBoundary: m32 = "viewport", elementContext: g32 = "floating", altBoundary: d32 = false, padding: p3 = 0 } = e44, h32 = a4(p3), y4 = c32[d32 ? "floating" === g32 ? "reference" : "floating" : g32], x3 = l7(await r32.getClippingRect({ element: null == (n32 = await (null == r32.isElement ? void 0 : r32.isElement(y4))) || n32 ? y4 : y4.contextElement || await (null == r32.getDocumentElement ? void 0 : r32.getDocumentElement(c32.floating)), boundary: u32, rootBoundary: m32, strategy: f32 })), w32 = "floating" === g32 ? __spreadProps(__spreadValues({}, s33.floating), { x: o42, y: i42 }) : s33.reference, v3 = await (null == r32.getOffsetParent ? void 0 : r32.getOffsetParent(c32.floating)), b32 = await (null == r32.isElement ? void 0 : r32.isElement(v3)) && await (null == r32.getScale ? void 0 : r32.getScale(v3)) || { x: 1, y: 1 }, R22 = l7(r32.convertOffsetParentRelativeRectToViewportRelativeRect ? await r32.convertOffsetParentRelativeRectToViewportRelativeRect({ rect: w32, offsetParent: v3, strategy: f32 }) : w32);
  return { top: (x3.top - R22.top + h32.top) / b32.y, bottom: (R22.bottom - x3.bottom + h32.bottom) / b32.y, left: (x3.left - R22.left + h32.left) / b32.x, right: (R22.right - x3.right + h32.right) / b32.x };
}
var c5 = Math.min;
var f5 = Math.max;
...
var m4 = (n32) => ({ name: "arrow", options: n32, async fn(i42) {
  ...
  if (null == r32)
    return {};
  const d32 = a4(l32), p3 = { x: s33, y: c32 }, h32 = o24(f32), y4 = e33(h32), x3 = await g32.getDimensions(r32), w32 = "y" === h32 ? "top" : "left", v3 = "y" === h32 ? "bottom" : "right", b32 = m32.reference[y4] + m32.reference[h32] - p3[h32] - m32.floating[y4], R22 = p3[h32] - m32.reference[h32], A22 = await (null == g32.getOffsetParent ? void 0 : g32.getOffsetParent(r32));
  let P3 = A22 ? "y" === h32 ? A22.clientHeight || 0 : A22.clientWidth || 0 : 0;
  0 === P3 && (P3 = m32.floating[y4]);
  const T3 = b32 / 2 - R22 / 2, O3 = d32[w32], D3 = P3 - x3[y4] - d32[v3], E32 = P3 / 2 - x3[y4] / 2 + T3, L3 = u6(O3, E32, D3), k22 = null != t5(f32) && E32 != L3 && m32.reference[y4] / 2 - (E32 < O3 ? d32[w32] : d32[v3]) - x3[y4] / 2 < 0;
  return { [h32]: p3[h32] - (k22 ? E32 < O3 ? O3 - E32 : D3 - E32 : 0), data: { [h32]: L3, centerOffset: E32 - L3 } };
} });
...
var b3 = function(e44) {
  return void 0 === e44 && (e44 = {}), { name: "flip", options: e44, async fn(o42) {
    var i42;
    const { placement: r32, middlewareData: a32, rects: l32, initialPlacement: c32, platform: f32, elements: u32 } = o42, _a2 = e44, { mainAxis: m32 = true, crossAxis: g32 = true, fallbackPlacements: d32, fallbackStrategy: p3 = "bestFit", fallbackAxisSideDirection: x3 = "none", flipAlignment: v3 = true } = _a2, b32 = __objRest(_a2, ["mainAxis", "crossAxis", "fallbackPlacements", "fallbackStrategy", "fallbackAxisSideDirection", "flipAlignment"]), R22 = n8(r32), A22 = n8(c32) === c32, P3 = await (null == f32.isRTL ? void 0 : f32.isRTL(u32.floating)), T3 = d32 || (A22 || !v3 ? [h3(c32)] : function(t22) {
      const e52 = h3(t22);
      return [w3(t22), e52, w3(e52)];
    }(c32));
    d32 || "none" === x3 || T3.push(...function(e52, o52, i52, r42) {
      const a42 = t5(e52);
      let l42 = function(t22, e62, n32) {
        const o62 = ["left", "right"], i6 = ["right", "left"], r5 = ["top", "bottom"], a5 = ["bottom", "top"];
        switch (t22) {
          case "top":
          case "bottom":
            return n32 ? e62 ? i6 : o62 : e62 ? o62 : i6;
          case "left":
          case "right":
            return e62 ? r5 : a5;
          default:
    ...
    const O3 = [c32, ...T3], D3 = await s7(o42, b32), E32 = [];
    let L3 = (null == (i42 = a32.flip) ? void 0 : i42.overflows) || [];
    if (m32 && E32.push(D3[R22]), g32) {
      const { main: t22, cross: e52 } = y22(r32, l32, P3);
...
var O = function(e44) {
  return void 0 === e44 && (e44 = 0), { name: "offset", options: e44, async fn(i42) {
    const { x: r32, y: a32 } = i42, l32 = await async function(e52, i52) {
      ...
      return f32 && "number" == typeof y4 && (h32 = "end" === f32 ? -1 * y4 : y4), u32 ? { x: h32 * g32, y: p3 * m32 } : { x: p3 * m32, y: h32 * g32 };
    }(i42, e44);
...
var E4 = function(t22) {
  return void 0 === t22 && (t22 = {}), { name: "shift", options: t22, async fn(e44) {
    const { x: i42, y: r32, placement: a32 } = e44, _a2 = t22, { mainAxis: l32 = true, crossAxis: c32 = false, limiter: f32 = { fn: (t33) => {
      let { x: e52, y: n32 } = t33;
      return { x: e52, y: n32 };
    } } } = _a2, m32 = __objRest(_a2, ["mainAxis", "crossAxis", "limiter"]), g32 = { x: i42, y: r32 }, d32 = await s7(e44, m32), p3 = o24(n8(a32)), h32 = D2(p3);
    let y4 = g32[p3], x3 = g32[h32];
    if (l32) {
      const t33 = "y" === p3 ? "bottom" : "right";
      y4 = u6(y4 + d32["y" === p3 ? "top" : "left"], y4, y4 - d32[t33]);
    }
    if (c32) {
      const t33 = "y" === h32 ? "bottom" : "right";
      x3 = u6(x3 + d32["y" === h32 ? "top" : "left"], x3, x3 - d32[t33]);
    }
    const w32 = f32.fn(__spreadProps(__spreadValues({}, e44), { [p3]: y4, [h32]: x3 }));
...
var k2 = function(e44) {
  return void 0 === e44 && (e44 = {}), { name: "size", options: e44, async fn(o42) {
    ...
    let p3, h32;
    "top" === g32 || "bottom" === g32 ? (p3 = g32, h32 = d32 === (await (null == a32.isRTL ? void 0 : a32.isRTL(l32.floating)) ? "start" : "end") ? "left" : "right") : (h32 = g32, p3 = "end" === d32 ? "top" : "bottom");
    const y4 = f5(m32.left, 0), x3 = f5(m32.right, 0), w32 = f5(m32.top, 0), v3 = f5(m32.bottom, 0), b32 = { availableHeight: r32.floating.height - (["left", "right"].includes(i42) ? 2 * (0 !== w32 || 0 !== v3 ? w32 + v3 : f5(m32.top, m32.bottom)) : m32[p3]), availableWidth: r32.floating.width - (["top", "bottom"].includes(i42) ? 2 * (0 !== y4 || 0 !== x3 ? y4 + x3 : f5(m32.left, m32.right)) : m32[h32]) };
...
function E22(t22, e44, o42, i42) {
  ...
  let h32 = (c32.left + (d32 && (null == (r32 = a32.visualViewport) ? void 0 : r32.offsetLeft) || 0)) / u32.x, g32 = (c32.top + (d32 && (null == (l32 = a32.visualViewport) ? void 0 : l32.offsetTop) || 0)) / u32.y, m32 = c32.width / u32.x, y4 = c32.height / u32.y;
  if (f32) {
    ...
    for (; o52 && i42 && e52 !== t33; ) {
      ...
      e62.x += (o52.clientLeft + parseFloat(i52.paddingLeft)) * t42.x, e62.y += (o52.clientTop + parseFloat(i52.paddingTop)) * t42.y, h32 *= t42.x, g32 *= t42.y, m32 *= t42.x, y4 *= t42.y, h32 += e62.x, g32 += e62.y, o52 = n22(o52).frameElement;
    }
  }
  return { width: m32, height: y4, top: g32, right: h32 + m32, bottom: g32 + y4, left: h32, x: h32, y: g32 };
}
function R2(t22) {
...
function makeKeyMatcher(type, sc, cb) {
  ...
  parts.forEach((p3) => {
    ...
    if (typeof modifiers[mod] !== "boolean")
      console.warn(`Unknown command modifier ${p3}.`);
    modifiers[mod] = true;
  });
  return (evt) => {
    if (type !== evt.type)
